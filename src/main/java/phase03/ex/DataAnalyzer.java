...
public class DataAnalyzer {
    ...
    private static void analyzeByCategory() {
        ...
        byCategory.entrySet().stream()
                .sorted((e1, e2) -> Double.compare(e2.getValue().getSum(), e1.getValue().getSum())).forEach(e -> {
...
record Order(String id, String product, String category, String customer, String month, double amount) {
    @Override
